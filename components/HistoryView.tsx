        ...
        <div className="space-y-6">
            <Card title="Query Historical Data">
                <div className="flex flex-col md:flex-row gap-4 items-center">
                 ...
                 <div className="mt-4 pt-4 border-t border-border flex flex-col md:flex-row gap-4 items-center justify-end">
                     <h4 className="text-sm font-medium text-text-secondary mr-auto md:mr-4">Export Data</h4>
                     <button
                        onClick={handleExportSensors}
                        disabled={data.sensors.length === 0}
                        className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-accent to-secondary-accent text-white rounded-lg hover:from-accent-hover hover:to-accent disabled:bg-primary/50 disabled:cursor-not-allowed transition-all w-full md:w-auto font-semibold"
